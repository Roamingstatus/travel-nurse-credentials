...
- [Persistent storage migration](persistent-storage.md) — documents now route through app/services/storage_service.py (local file storage with extensibility for cloud providers); storage_provider column in documents table
